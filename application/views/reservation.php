                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <p>
                                Homme <input type="radio" class="flat" name="sexe" id="genderM" value="H" checked="" required />
                                Femme <input type="radio" class="flat" name="sexe" id="genderF" value="F" />
                            </p>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <input class="date-picker form-control" placeholder="dd-mm-yyyy" name="dateVaccin" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)">
                            <script>
                                function timeFunctionLong(input) {
                                    setTimeout(function() {
                                        input.type = 'text';
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <div class="checkbox">
                                <input type="hidden" class="flat" name="idMaladies[]" value="aucun">
